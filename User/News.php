...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="strip" class="box noprint">
            ...
            <!-- Breadcrumbs -->
            <p id="breadcrumbs">You are here: <a href="News.php">View Information</a></p>
          <hr class="noscreen" />
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Welcome To Information List</a></span></h2>
               

                <table width="100%" border="0" cellspacing="0" cellpadding="0">
           
                  <tr>
                    <td height="25" bgcolor="#A0B9F3"><span class="style3">&nbsp;&nbsp;&nbsp;Information List</span></td>
                  </tr>
                  <tr>
                    <td>
			<div style="overflow:scroll; width:630px;height:332px" >
