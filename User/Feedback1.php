...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="strip" class="box noprint">
            ...
            <!-- Breadcrumbs -->
            <p id="breadcrumbs">You are here: <a href="Feedback1.php">Feedback</a></p>
          <hr class="noscreen" />
        ...
        <div id="content">
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td><label><div align="center">
                            <input type="submit" name="button" id="button" value="Send Feedback" align="center" />
			  </div>  
                          </label></td>
                        </tr>
                      </table>
		  ...
		  <tr>
          	  <td height="25" bgcolor="#A0B9F3"><strong>&nbsp;&nbsp;&nbsp;Your feedback</strong></td>
                  </tr>
		  <tr>
                   <td>
...
$sql = "select * from feedback INNER JOIN (user,account) ON (feedback.UserId=user.UserId AND feedback.UserId=account.UserId) WHERE feedback.UserId=$ID ORDER BY feedback.FeedbackDate";
// Execute query
