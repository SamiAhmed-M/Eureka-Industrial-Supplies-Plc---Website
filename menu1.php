<!-- Main menu (tabs) -->
     <div id="tabs" class="noprint">
		...
		<li><a href="OurProducts.php">Our Products<span class="tab-l"></span><span class="tab-r"></span></a></li>
		<li><a href="ServicePictorials.php">Service Pictorials<span class="tab-l"></span><span class="tab-r"></span></a></li>
