...
{    
 // when button-upload button is clicked 
	...
	$final_file=str_replace(' ','-',$new_file_name);
       ...
       {
        //move the new file from the temporary location file_loc to uploads/new file name in uploads folder	
	if(move_uploaded_file($file_loc,$folder.$final_file))
	{
		...
		alert('successfully uploaded');
                window.location.href='CompanyProducts1.php?success';
                </script>
		<?php
	}
	else
	{
        ...
        window.location.href='CompanyProducts1.php?fail';
        </script>
		<?php
	}
       }
       ...
       {
        echo '<script type="text/javascript">alert("Please upload image type .png or .jpeg or .gif or .bmp only!");window.location=\'CompanyProducts1.php\';</script>';
	exit();
