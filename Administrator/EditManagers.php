...
$sql = "select administrator.*,account.* from administrator INNER JOIN account ON administrator.AdminId=account.AdminId where administrator.AdminId='".$Id."'";
// Execute query
...
?>
                        <form method="post" action="UpdateManagers.php">
                          <table width="100%" border="0">
                            <tr>
                              <td height="32"><span class="style8">Manager Id</span></td>
                              <td><span id="sprytextfield1">
                                <label><div align="center">
                                <input name="txtManagerId" type="text" id="txtManagerId" readonly="true" size="35" value="<?php echo $ManagerId;?>" />
                                </div></label>
                            ...
                            <tr>
                              ...
                              <td><span id="sprytextfield2">
                                <label><div align="center">
                                <input name="txtManagerFirstName" type="text" id="txtManagerFirstName" size="35" value="<?php echo $FirstName;?>" />
                                </div></label>
                                <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                            </tr>
			    <tr>
                              ...
                              <td><span id="sprytextfield3">
                                <label><div align="center">
                                <input name="txtManagerMiddleName" type="text" id="txtManagerMiddleName" size="35" value="<?php echo $MiddleName;?>" />
                                </div></label>
                                <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                            </tr>
			    <tr>
                              ...
                              <td><span id="sprytextfield4">
                                <label><div align="center">
                                <input name="txtManagerLastName" type="text" id="txtManagerLastName" size="35" value="<?php echo $LastName;?>" />
                                </div></label>
                                <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td height="36"><span class="style8">Sup. E_Mail:</span></td>
