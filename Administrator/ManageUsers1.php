...
<!-- Page (2 columns) -->
        ...
        <div id="strip" class="box noprint">
            ...
            <p id="breadcrumbs">You are here:<strong><a href="ManageUsers1.php">Manage Users</a></strong></p>
            <hr class="noscreen" />
...
<td class="style3"><div align="left" class="style9 style5"><strong><a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='DeleteUsers1.php?UserId=<?php echo $Id;?>';}">Delete</a></strong></div></td>
