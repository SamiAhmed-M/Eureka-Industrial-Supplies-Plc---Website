...
private $NewsDate;
  ...
  function Delete(){
	...
	$result = mysqli_query($con,$sql) or die(mysqli_error($con));
        if ($result)
	{
        echo '<script type="text/javascript">alert("News Record Deleted Succesfully");window.location=\'ManageNews11.php\';</script>';
	}
	else
	{
        echo '<script type="text/javascript">alert("Deletion failed!");window.location=\'ManageNews11.php\';</script>';
	}
   ...
   function Edit(){
	...
	if(empty($News))
	{
	echo '<script type="text/javascript">alert("News Field information Required!");window.location=\'ManageNews11.php\';</script>';
	exit();
	}
	...
	// Close The Connection
	mysqli_close($con);
	echo '<script type="text/javascript">alert("News Record Updated Succesfully");window.location=\'ManageNews11.php\';</script>';
	}
	...
	mysqli_query($con,$sql) or die(mysqli_error($con));
        // Close The Connection
	mysqli_close ($con);
	echo '<script type="text/javascript">alert("News Record Inserted Succesfully");window.location=\'ManageNews11.php\';</script>';
