...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="strip" class="box noprint">
            ...
            <!-- Breadcrumbs -->
            <p id="breadcrumbs">You are here: <a href="CompanyProducts1.php">Manage Company Product Images</a></p>
          <hr class="noscreen" />
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Edit Company Product Image Detail</a></span></h2>
...
$sql = "select * from tbl_uploads where file='".$Id."'";
// Execute query
...
?>
                        <form method="post" action="UpdateImages1.php">
