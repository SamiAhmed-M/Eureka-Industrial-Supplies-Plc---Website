...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="strip" class="box noprint">
            ...
            <!-- Breadcrumbs -->
            <p id="breadcrumbs">You are here: <a href="CompanyProducts.php">Manage Images of Company Products</a></p>
          <hr class="noscreen" />
...
<td class="style3"><div align="left" class="style9 style5"><strong><a href="uploadEdit.php?ImageId=<?php echo $image;?>">Edit</a></strong></div></td>
<td class="style3"><div align="left" class="style9 style5"><strong><a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='DeleteImages.php?ImageId=<?php echo $image;?>';}">Delete</a></strong></div></td>
</tr>
<?php
}
