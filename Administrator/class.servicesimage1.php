...
private $size;
  ...
  function Delete(){
	...
	$result = mysqli_query($con,$sql) or die(mysqli_error($con));
        ...
        if ($result)
	{
	echo '<script type="text/javascript">alert("Image Deleted Succesfully");window.location=\'CompanyServices1.php\';</script>';
	}
	else
	{
	echo '<script type="text/javascript">alert("Image not deleted!!!");window.location=\'CompanyServices1.php\';</script>';
	}
   ...
   function Edit(){
	...
	{
	echo '<script type="text/javascript">alert("Information about the image is Required!");window.location=\'CompanyServices1.php\';</script>';
	exit();
	}
	...
	// Close The Connection
	mysqli_close($con);
	echo '<script type="text/javascript">alert("Image Description Updated Succesfully");window.location=\'CompanyServices1.php\';</script>';
	}
