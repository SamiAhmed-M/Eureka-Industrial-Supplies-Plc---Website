...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="strip" class="box noprint">
            ...
            <!-- Breadcrumbs -->
            <p id="breadcrumbs">You are here: <a href="CompanyServices1.php">Manage Images of Company Services</a></p>
          <hr class="noscreen" />
	...
	<form id="form1" name="form1" action="uploadservices1.php" method="post" enctype="multipart/form-data">
	...
	?>
        ...
        <tr>
          <td height="25" bgcolor="#A0B9F3"><strong>Company Services List</strong></td>
        </tr>
        <tr>
            <td>
...
<td class="style3"><div align="left" class="style9 style5"><strong><a href="uploadservicesEdit1.php?ImageId=<?php echo $image;?>">Edit</a></strong></div></td>
<td class="style3"><div align="left" class="style9 style5"><strong><a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='DeleteServicesImages1.php?ImageId=<?php echo $image;?>';}">Delete</a></strong></div></td>
</tr>
<?php
}
