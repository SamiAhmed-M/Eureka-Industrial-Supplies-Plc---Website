...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="strip" class="box noprint">
            ...
            <!-- Breadcrumbs -->
            <p id="breadcrumbs">You are here: <a href="Feedback.php">View Customers Feedback</a></p>
          <hr class="noscreen" />
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Customers Feedback</a></span></h2>
...
?>
		    ...
		    <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $Email;?></strong></div></td>
                    ...
                    <td class="style3"><div align="left" class="style9 style5"><strong><a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='DeleteFeedback.php?FeedbackId=<?php echo $Id;?>';}">Delete</a></strong></div></td>
                  </tr>
                  <?php
}
