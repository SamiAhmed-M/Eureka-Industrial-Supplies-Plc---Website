...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="strip" class="box noprint">
            ...
            <!-- Breadcrumbs -->
            <p id="breadcrumbs">You are here: <a href="ManageNews1.php">Back to Manage Information</a></p>
          <hr class="noscreen" />
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Edit News Detail</a></span></h2>
...
?>
                        <form method="post" action="UpdateNews1.php">
                          <table width="100%" border="0">
			    <tr>
                              <td height="32"><span class="style8">Information Id:</span></td>
                              <td><span id="sprytextfield14">
                                <label> 
                                <input name="txtNewsId" type="text" id="txtNewsId" readonly="true" value="<?php echo $Id;?>" />
                                </label>
                                <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                            </tr>
                            <tr>
                              <td height="32"><span class="style8">Information Date:</span></td>
                            ...
                            <tr>
                              <td height="32"><span class="style8">Information:</span></td>
                              <td><span id="sprytextfield2">
                                <label>
                                <textarea name="txtNews"  id="txtNews" cols="35" rows="5" wrap="virtual"><?php echo $News;?></textarea>
                                </label>
                                <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                            </tr>
                            <tr>
