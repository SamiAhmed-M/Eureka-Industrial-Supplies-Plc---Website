...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="strip" class="box noprint">
            ...
            <!-- Breadcrumbs -->
            <p id="breadcrumbs">You are here: <a href="CompanyProducts1.php">Manage Images of Company Products</a></p>
          <hr class="noscreen" />
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
              <h2><span><a href="#">Welcome to Company Products Image Upload Panel</a></span></h2>
               

                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="27" bgcolor="#A0B9F3"><strong>Upload Images of Company Products</strong></td>
        </tr>
        <tr>
          <td height="26">
               
	<form id="form1" name="form1" action="upload1.php" method="post" enctype="multipart/form-data">
	...
	{
		?>
        <label>Try to upload image files(JPEG, JPG, PNG, BMP & GIF only)</label>
        <?php
	}
	?>
...
<td class="style3"><div align="left" class="style9 style5"><strong><?php echo '<img src="uploads/'.$image.'" width="360" height="150">' ?></strong></div></td>
<td class="style3"><div align="left" class="style9 style5"><strong><a href="uploadEdit1.php?ImageId=<?php echo $image;?>">Edit</a></strong></div></td>
<td class="style3"><div align="left" class="style9 style5"><strong><a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='DeleteImages1.php?ImageId=<?php echo $image;?>';}">Delete</a></strong></div></td>
</tr>
<?php
}
